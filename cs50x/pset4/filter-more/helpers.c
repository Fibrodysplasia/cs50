...
void edges(int height, int width, RGBTRIPLE image[height][width]) {
    ...
    // (a Sobel array is a 3x3 array of integers)
    // Sobel edge detection algo is a fun read
    ...
    for (int i = 0; i < height; i++) {
        ...
        for (int j = 0; j < width; j++) {
            ...
            int red = (round(sqrt(Gx_red * Gx_red + Gy_red * Gy_red)) < 255) ? round(sqrt(Gx_red * Gx_red + Gy_red * Gy_red)) : 255;
            int green = (round(sqrt(Gx_green * Gx_green + Gy_green * Gy_green)) < 255) ? round(sqrt(Gx_green * Gx_green + Gy_green * Gy_green)) : 255;
            int blue = (round(sqrt(Gx_blue * Gx_blue + Gy_blue * Gy_blue)) < 255) ? round(sqrt(Gx_blue * Gx_blue + Gy_blue * Gy_blue)) : 255;
